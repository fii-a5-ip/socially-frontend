export const ro = {
  ...
  // Onboarding
  'onboarding.title': 'Hai să-ți calibrăm profilul',
  'onboarding.desc': 'Răspunde la 3 întrebări scurte, iar AI-ul alege filtrele potrivite pentru recomandări.',
  'onboarding.name': 'Nume',
  'onboarding.name_placeholder': 'Cum să ți se spună?',
  'onboarding.age': 'Vârstă',
  'onboarding.city': 'Oraș',
  'onboarding.city_placeholder': 'Iași',
  'onboarding.occupation': 'Ocupație',
  'onboarding.occupation_placeholder': 'Alege o variantă',
  'onboarding.occupation_student': 'Student',
  'onboarding.occupation_employee': 'Angajat',
  'onboarding.occupation_entrepreneur': 'Antreprenor',
  'onboarding.occupation_other': 'Altceva',
  'onboarding.remote': 'Lucrez / studiez remote des',
  'onboarding.ai_label': 'Întrebarea AI',
  'onboarding.answer_label': 'Răspunsul tău',
  'onboarding.answer_placeholder': 'Scrie natural, cu câteva detalii despre ce îți place sau ce eviți...',
  'onboarding.answer_hint': 'Minim 30 de caractere. Istoricul se trimite acumulativ către AI.',
  'onboarding.btn_start': 'Pornește conversația',
  'onboarding.btn_next': 'Trimite răspunsul',
  'onboarding.btn_finish': 'Finalizează profilul',
  'onboarding.btn_restart': 'Reia de la formular',
  'onboarding.btn_loading': 'Se procesează...',
  'onboarding.btn_retrying': 'AI ocupat, reîncerc...',
  'onboarding.progress_label': 'Progres onboarding',
  'onboarding.fallback_question': 'Hai să continuăm. Ce altceva preferi?',
  'onboarding.error_short_answer': 'Te rog oferă un răspuns mai detaliat, de minimum 30 de caractere.',
  'onboarding.error_rate_limit': 'AI-ul este ocupat momentan. Am reîncercat, dar încearcă din nou peste puțin timp.',
  'onboarding.error_generic': 'Nu am putut procesa onboarding-ul acum. Încearcă din nou.',
  'onboarding.error_auth': 'Trebuie să fii autentificat pentru a salva filtrele.',
  'onboarding.error_save': 'Filtrele au fost calculate, dar nu au putut fi salvate pe profil.',
  ...
  'createevent.form.image': 'Imagine Eveniment',
  'createevent.form.click_to_upload': 'Click pentru a încărca o imagine din PC',
  'createevent.form.or_enter_url': 'Sau introdu un link URL pentru imagine:',
  ...
  'common.search': '🔍 Caută printre sute de interese...',
