...
/* ── Flag SVGs inline (no image files needed) ── 
const FlagRO = () => (
  <svg width="22" height="22" viewBox="0 0 3 2" className="nb-flag">
...
const FlagEN = () => (
  <svg width="22" height="22" viewBox="0 0 60 30" className="nb-flag">
      ...
      <nav className="nb-top">
        <div className="nb-top__inner">
          ...
          <div className="nb-search">
            <span className="nb-search__icon"><IconSearch /></span>
            <input
          ...
          <div className="nb-top__controls">
            ...
            <button className="nb-icon-btn" onClick={() => setTheme(t => t === 'light' ? 'dark' : 'light')}>
